...
export const HOME_TITLE = "Safe Online Dating & Matchmaking in India | ConnectLove";
export const HOME_DESCRIPTION =
  "Meet verified Indian singles on ConnectLove, a safe online dating and matchmaking platform for meaningful relationships. Create your profile and start matching.";
