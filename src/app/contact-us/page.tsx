...
export default function ContactUsPage() {
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      />
      <main>
        <section className="border-b border-rose-100 bg-gradient-to-b from-rose-50 via-white to-slate-50 py-14 md:py-20">
          <div className="mx-auto w-[90vw] max-w-5xl text-center">
            ...
            <h1 className="mx-auto mt-4 max-w-3xl text-4xl font-black tracking-tight text-slate-950 md:text-5xl">
            ...
            {supportTopics.map((topic) => {
              ...
              return (
                <article key={topic.title} className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                  ...
                  <h2 className="mt-4 text-base font-bold text-slate-900">{topic.title}</h2>
          ...
          <div className="mt-10 grid items-start gap-8 lg:grid-cols-[minmax(0,1fr)_280px]">
            ...
            <aside className="space-y-4 lg:sticky lg:top-24">
              ...
              <div className="rounded-2xl border border-rose-200 bg-rose-50 p-5">
                ...
                <h2 className="mt-3 text-sm font-bold text-slate-900">Help us respond faster</h2>
