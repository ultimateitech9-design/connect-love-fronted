...
function ManagementNavbar() {
 ...
 <div className="mx-auto flex h-[5vw] items-center px-6 py-4">
 {/* Logo */}
...
export default function ManagementPage() {
 ...
 >
 <span className="flex h-[0.556vw] w-[0.556vw] rounded-full bg-rose-500 mr-2 animate-pulse"></span>
 Management Portal
 </motion.div>
 ...
 <div className="h-[4.444vw] w-[4.444vw] rounded-full bg-blue-50 text-blue-500 flex items-center justify-center mb-4">
 <ShieldCheck className="h-[2.222vw] w-[2.222vw]" />
 </div>
 ...
 {/* Super Admin Card */}
 <div className="bg-white rounded-2xl p-6 shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col items-center hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
 <div className="h-[4.444vw] w-[4.444vw] rounded-full bg-rose-50 text-rose-500 flex items-center justify-center mb-4">
 <ShieldAlert className="h-[2.222vw] w-[2.222vw]" />
 </div>
 ...
 {/* Marketing Card */}
 <div className="bg-white rounded-2xl p-6 shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col items-center hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
 <div className="h-[4.444vw] w-[4.444vw] rounded-full bg-violet-50 text-violet-500 flex items-center justify-center mb-4">
 <Megaphone className="h-[2.222vw] w-[2.222vw]" />
 </div>
 ...
 {/* Finance Card */}
 <div className="bg-white rounded-2xl p-6 shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col items-center hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
 <div className="h-[4.444vw] w-[4.444vw] rounded-full bg-emerald-50 text-emerald-500 flex items-center justify-center mb-4">
 <CreditCard className="h-[2.222vw] w-[2.222vw]" />
 </div>
 ...
 {/* Sales Card */}
 <div className="bg-white rounded-2xl p-6 shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col items-center hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
 <div className="h-[4.444vw] w-[4.444vw] rounded-full bg-amber-50 text-amber-500 flex items-center justify-center mb-4">
 <TrendingUp className="h-[2.222vw] w-[2.222vw]" />
 </div>
 ...
 {/* Support Card */}
 <div className="bg-white rounded-2xl p-6 shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col items-center hover:shadow-2xl hover:-translate-y-1 transition-all duration-300">
 <div className="h-[4.444vw] w-[4.444vw] rounded-full bg-cyan-50 text-cyan-500 flex items-center justify-center mb-4">
 <Headphones className="h-[2.222vw] w-[2.222vw]" />
 </div>
