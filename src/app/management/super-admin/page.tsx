...
import { ShieldCheck, Eye, EyeOff, Loader2, Lock, Mail, ShieldAlert, Heart } from "lucide-react";
...
export default function SuperAdminLoginPage() {
 ...
 setTimeout(() => setLocked(false), 2000);
    ...
    try {
      const result = await loginManagement(email, password, "super-admin");
 ...
 <div className="h-16 w-16 bg-gradient-to-br from-rose-500 to-rose-700 rounded-2xl flex items-center justify-center shadow-lg shadow-rose-500/30 mb-6">
 <ShieldAlert className="h-8 w-8 text-white" />
 </div>
 <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Super Admin Portal</h1>
 ...
 >
 {loading ? <Loader2 className="h-5 w-5 animate-spin" /> : "Login as Super Admin"}
 </Button>
 </motion.form>
 )}
