...
import { ShieldCheck, Eye, EyeOff, Loader2, Lock, Mail, ShieldAlert, Heart, Megaphone } from "lucide-react";
...
export default function MarketingLoginPage() {
 ...
 setTimeout(() => setLocked(false), 2000);
    ...
    try {
      const result = await loginManagement(email, password, "marketing");
 ...
 return (
 <div className="relative flex min-h-screen w-full items-center justify-center overflow-x-hidden bg-slate-50 px-4 py-6 selection:bg-rose-500/30">
 ...
 <div className="h-16 w-16 bg-gradient-to-br from-violet-500 to-violet-700 rounded-2xl flex items-center justify-center shadow-lg shadow-violet-500/30 mb-6">
 <Megaphone className="h-8 w-8 text-white" />
 </div>
 <h1 className="text-2xl font-bold text-slate-900 tracking-tight">Marketing Portal</h1>
 ...
 className="pl-10 bg-white border-slate-200 text-slate-900 placeholder:text-slate-400 focus:border-rose-500/50 focus:ring-rose-500/20 h-11"
 />
 </div>
 </div>
 ...
 placeholder="••••••••"
 className="pl-10 pr-10 bg-white border-slate-200 text-slate-900 placeholder:text-slate-400 focus:border-rose-500/50 focus:ring-rose-500/20 h-11"
 />
 <button 
 type="button" 
 ...
 className="w-full h-11 mt-4 bg-gradient-to-r from-rose-500 to-rose-600 hover:from-rose-400 hover:to-rose-500 text-white border-0 shadow-[0_0_20px_rgba(225,29,72,0.3)] hover:shadow-[0_0_25px_rgba(225,29,72,0.5)] transition-all font-semibold rounded-xl"
 >
 {loading ? <Loader2 className="h-5 w-5 animate-spin" /> : "Login as Marketing"}
 </Button>
 </motion.form>
 )}
 ...
 <Mail className="h-12 w-12 text-rose-500 mx-auto opacity-80" />
 ...
 className="flex-1 h-11 bg-transparent border-slate-200 text-slate-600 hover:bg-slate-50 hover:text-slate-900 shadow-sm rounded-xl"
 >
 Back
 </Button>
 <Button 
 ...
 className="flex-1 h-11 bg-rose-500 hover:bg-rose-400 text-white border-0 shadow-[0_0_15px_rgba(225,29,72,0.3)] transition-all font-semibold rounded-xl"
 >
 ...
 <img src="/connect-love-logo.png" alt="" className="h-4 w-4 rounded" /> ConnectLove Secure Admin
 </span>
 </div>
 </div>
 );
