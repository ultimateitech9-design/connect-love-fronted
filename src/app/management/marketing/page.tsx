...
export default function MarketingLoginPage() {
 ...
 <div className="h-[4.444vw] w-[4.444vw] bg-gradient-to-br from-violet-500 to-violet-700 rounded-2xl flex items-center justify-center shadow-lg shadow-violet-500/30 mb-6">
 <Megaphone className="h-[2.222vw] w-[2.222vw] text-white" />
 </div>
 ...
 >
 {loading ? <Loader2 className="h-[1.389vw] w-[1.389vw] animate-spin" /> : "Login as Marketing"}
 </Button>
 </motion.form>
 )}
