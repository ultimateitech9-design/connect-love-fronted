...
export default function FinanceLoginPage() {
 ...
 <div className="h-16 w-16 bg-gradient-to-br from-emerald-500 to-emerald-700 rounded-2xl flex items-center justify-center shadow-lg shadow-emerald-500/30 mb-6">
 ...
 >
 {loading ? <Loader2 className="h-5 w-5 animate-spin" /> : "Login as Finance"}
 </Button>
 </motion.form>
 )}
