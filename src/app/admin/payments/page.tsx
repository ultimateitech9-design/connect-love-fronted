...
export default function PaymentsPage() {
 ...
 <tr><td colSpan={5} className="px-5 py-8 text-center text-muted-foreground">Database me abhi payment records nahi hain.</td></tr>
 ) : payments.map((p) => (
 ...
 <td className="px-5 py-3 font-semibold text-slate-700">{String(p.currency || "INR").toUpperCase() === "INR" ? "₹" : "$"}{Number(p.amount).toFixed(2)}</td>
