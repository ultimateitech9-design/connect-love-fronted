...
export default function PrivacyPolicyPage() {
  const page: PublicPageData = {
    ...
    roleAccess: [{ role: "User", access: "Own profile, photos, messages, preferences, premium, and settings." }, { role: "Support", access: "Tickets, contact context, and report details needed for resolution." }, { role: "Finance", access: "Subscriptions, payments, invoices, transactions, and refunds." }, { role: "Admin", access: "Users, reports, verification, tickets, subscriptions, payments, and analytics." }, { role: "Super Admin", access: "Roles, settings, security, logs, notifications, users, payments, and verification." }],
