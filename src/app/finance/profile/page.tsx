...
export default function ProfilePage() {
 ...
 className="h-[3.056vw] px-4 rounded-lg bg-muted text-sm outline-none focus:ring-2 focus:ring-ring w-full transition-shadow" 
 />
 </label>
 ...
 <button 
 type="button"
 className="w-full sm:w-auto inline-flex items-center justify-center gap-2 h-[3.056vw] px-6 rounded-lg text-destructive font-medium bg-destructive/10 hover:bg-destructive/20 transition-colors"
 ...
 <button 
 type="submit"
 className="w-full sm:w-auto inline-flex items-center justify-center gap-2 h-[3.056vw] px-8 rounded-lg text-white font-medium shadow-[0_10px_30px_-10px_rgba(244,114,182,0.5)] transition-transform active:scale-95 hover:opacity-90" 
