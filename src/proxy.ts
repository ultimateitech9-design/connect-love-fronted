...
const protectedManagementPaths = ["/admin", "/super-admin", "/marketing", "/finance", "/sales", "/support"];
...
export const config = {
  matcher: ["/user/:path*", "/admin/:path*", "/super-admin/:path*", "/marketing/:path*", "/finance/:path*", "/sales/:path*", "/support/:path*"],
};
